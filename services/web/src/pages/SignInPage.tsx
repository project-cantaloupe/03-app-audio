...
export function SignInPage() {
  ...
  const heading = session
    ...
    : mode === "disabled"
      ...
      : "Sign in to publish and save audio";
  const description = session
    ...
    : mode === "disabled"
      ? "Sign-in and sign-up will return after the public Audio identity boundary is ready. Public listening remains available."
      : mode === "oidc"
